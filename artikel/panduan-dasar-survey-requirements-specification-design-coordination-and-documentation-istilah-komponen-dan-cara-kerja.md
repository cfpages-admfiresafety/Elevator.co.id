...
description: "Pembaca dapat mengenali istilah, komponen, hubungan antarkomponen, dan kapan Survey, requirements, specification, design coordination, and documentation relevan."
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Panduan Dasar Survey, requirements, specification, design coordination, and documentation: Istilah, Komponen, dan Cara Kerja”
- **Reader and situation:** Pembaca baru yang memerlukan model mental benar sebelum menentukan kebutuhan.
- **Reader outcome:** Pembaca dapat mengenali istilah, komponen, hubungan antarkomponen, dan kapan Survey, requirements, specification, design coordination, and documentation relevan.
- **Primary intent:** Memahami definisi, komponen, mekanisme, dan batas sistem Survey, requirements, specification, design coordination, and documentation.
...
- **Scope boundary:** Tidak membandingkan opsi atau menetapkan spesifikasi; intent tersebut dimiliki ELV-10-02 dan ELV-10-03.
- **Final public route:** `/artikel/panduan-dasar-survey-requirements-specification-design-coordination-and-documentation-istilah-komponen-dan-cara-kerja.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Panduan Dasar Survey, requirements, specification, design coordination, and documentation: Istilah, Komponen, dan Cara Kerja**.
...
- **Tie back to this article:** Keep the explanation specific to “Panduan Dasar Survey, requirements, specification, design coordination, and documentation: Istilah, Komponen, dan Cara Kerja”.
