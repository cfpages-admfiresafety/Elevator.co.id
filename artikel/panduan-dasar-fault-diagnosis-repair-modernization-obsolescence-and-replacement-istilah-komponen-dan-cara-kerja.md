...
description: "Pembaca dapat mengenali istilah, komponen, hubungan antarkomponen, dan kapan Fault diagnosis, repair, modernization, obsolescence, and replacement relevan."
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Panduan Dasar Fault diagnosis, repair, modernization, obsolescence, and replacement: Istilah, Komponen, dan Cara Kerja”
- **Reader and situation:** Pembaca baru yang memerlukan model mental benar sebelum menentukan kebutuhan.
- **Reader outcome:** Pembaca dapat mengenali istilah, komponen, hubungan antarkomponen, dan kapan Fault diagnosis, repair, modernization, obsolescence, and replacement relevan.
- **Primary intent:** Memahami definisi, komponen, mekanisme, dan batas sistem Fault diagnosis, repair, modernization, obsolescence, and replacement.
...
- **Scope boundary:** Tidak membandingkan opsi atau menetapkan spesifikasi; intent tersebut dimiliki ELV-14-02 dan ELV-14-03.
- **Final public route:** `/artikel/panduan-dasar-fault-diagnosis-repair-modernization-obsolescence-and-replacement-istilah-komponen-dan-cara-kerja.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Panduan Dasar Fault diagnosis, repair, modernization, obsolescence, and replacement: Istilah, Komponen, dan Cara Kerja**.
...
- **Tie back to this article:** Keep the explanation specific to “Panduan Dasar Fault diagnosis, repair, modernization, obsolescence, and replacement: Istilah, Komponen, dan Cara Kerja”.
