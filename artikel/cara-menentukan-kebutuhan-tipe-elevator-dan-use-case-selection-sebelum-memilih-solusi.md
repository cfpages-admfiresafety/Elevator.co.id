...
- **Writer task:** Expand this file into one complete article answering: “Cara Menentukan Kebutuhan Tipe elevator dan use-case selection Sebelum Memilih Solusi”
...
- **Primary intent:** Menerjemahkan fungsi, lokasi, pengguna, risiko, dan target mutu menjadi persyaratan Tipe elevator dan use-case selection.
...
- **Scope boundary:** Tidak menghitung anggaran rinci atau menjelaskan urutan pelaksanaan; intent tersebut dimiliki ELV-02-04 dan ELV-02-05.
- **Final public route:** `/artikel/cara-menentukan-kebutuhan-tipe-elevator-dan-use-case-selection-sebelum-memilih-solusi.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Cara Menentukan Kebutuhan Tipe elevator dan use-case selection Sebelum Memilih Solusi**.
...
- **Tie back to this article:** Keep the explanation specific to “Cara Menentukan Kebutuhan Tipe elevator dan use-case selection Sebelum Memilih Solusi”.
