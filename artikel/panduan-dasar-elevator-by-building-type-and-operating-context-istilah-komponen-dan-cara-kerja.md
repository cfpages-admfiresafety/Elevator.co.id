...
description: "Pembaca dapat mengenali istilah, komponen, hubungan antarkomponen, dan kapan Elevator by building type and operating context relevan."
status: outline
...
- **Writer task:** Expand this file into one complete article answering: “Panduan Dasar Elevator by building type and operating context: Istilah, Komponen, dan Cara Kerja”
- **Reader and situation:** Pembaca baru yang memerlukan model mental benar sebelum menentukan kebutuhan.
- **Reader outcome:** Pembaca dapat mengenali istilah, komponen, hubungan antarkomponen, dan kapan Elevator by building type and operating context relevan.
- **Primary intent:** Memahami definisi, komponen, mekanisme, dan batas sistem Elevator by building type and operating context.
...
- **Scope boundary:** Tidak membandingkan opsi atau menetapkan spesifikasi; intent tersebut dimiliki ELV-15-02 dan ELV-15-03.
- **Final public route:** `/artikel/panduan-dasar-elevator-by-building-type-and-operating-context-istilah-komponen-dan-cara-kerja.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Panduan Dasar Elevator by building type and operating context: Istilah, Komponen, dan Cara Kerja**.
...
- **Tie back to this article:** Keep the explanation specific to “Panduan Dasar Elevator by building type and operating context: Istilah, Komponen, dan Cara Kerja”.
